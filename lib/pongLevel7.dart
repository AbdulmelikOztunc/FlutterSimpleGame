...
import 'bat.dart';
import 'main.dart';
import 'pongLevel8.dart';

int setScore1 = 0;
int setScore2 = 0;

class PongLevel7 extends StatefulWidget {
  int setScore1;
  int setScore2;
  PongLevel7(this.setScore1, this.setScore2);

  @override
  _PongLevel7State createState() => _PongLevel7State();
}

class _PongLevel7State extends State<PongLevel7>
...
class Level6Screen extends StatelessWidget {
