...
class PongLevel4 extends StatefulWidget {
  int setScore1;
  int setScore2;
  PongLevel4(this.setScore1, this.setScore2);

  @override
  _PongLevel4State createState() => _PongLevel4State();
}

class _PongLevel4State extends State<PongLevel4>
