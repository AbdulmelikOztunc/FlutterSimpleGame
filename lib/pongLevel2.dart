...
import 'package:simple_pong/pongLevel3.dart';
import 'helper.dart';
...
class PongLevel2 extends StatefulWidget {
  int setScore1;
  int setScore2;
  PongLevel2(this.setScore1, this.setScore2);

  @override
  _PongLevel2State createState() => _PongLevel2State();
}

class _PongLevel2State extends State<PongLevel2>
